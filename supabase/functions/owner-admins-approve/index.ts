...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    await writeAuditLog({ actorId: user.id, action: "admin_approved", entityType: "assignment", entityId: assignmentId, before: target, after: { status: "active", roles: roleKeys } });
